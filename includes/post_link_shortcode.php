 ...
 * - noanchor - string, "yes" or "no" - indicates whether to return just a permalink or full anchor
 ...
 * - [post]
 * - [post id="42"]
 * - [post id="42" class="extra-link-class"]
 * - [post id="42" title="My post"]
 * - [post id="42" title="See %s"]
 * - [post id="42" title="The other post" text="click here"]
 * - [post id="42" text="Visit %s"]
 *
...
if ( function_exists( 'add_shortcode' ) && ! function_exists( 'post_link_shortcode' ) ) {
	function post_link_shortcode( $atts, $content = "" ) {
